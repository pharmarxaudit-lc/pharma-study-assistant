...
This script reads the second study guide PDF and converts each
...
STUDY_GUIDE_TEXT = """
Preguntas Examen de Leyes - 117 Study Points

SECTION 1: First 60 Questions (Pages 1-3)
...
SECTION 2: Additional 57 Questions (Pages 4-9)
...
Convert each study point below into 1-2 exam questions following this EXACT format:
...
- Use proper regulatory references (Ley 247 de 2004, Ley 243 de 1938, Reglamento 156, Reglamento 153, etc.)
- Some study points already contain example questions - use those as inspiration but create proper formatted questions
...
def main():
    ...
    parser.add_argument('--output', default='/tmp/preguntas_examen_questions.json',
    ...
    logger.info("="*80)
    logger.info("PREGUNTAS EXAMEN DE LEYES - STUDY GUIDE TO QUESTIONS CONVERTER")
    logger.info("="*80)
